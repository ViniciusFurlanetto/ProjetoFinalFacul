 ...
 */
public class RelatorioComissaoRepres extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Relatório de comissões");
    ...
    private void BtnGerarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnGerarActionPerformed
        ...
        if (fValidaData()) {
            List<ComissaoRepresModel> PedidoList;
            ComissaoRepresModel Ped = new ComissaoRepresModel();
    ...
    public void imprimir(List<ComissaoRepresModel> itens) throws Exception {
        JasperReport report = JasperCompileManager.compileReport(this.getPathToReportPackage() + "ComisRep.jrxml");
        JasperPrint print = JasperFillManager.fillReport(report, null, new JRBeanCollectionDataSource(itens));
        JasperExportManager.exportReportToPdfFile(print, this.getPathToReportPackage() + "RelatorioComisRep.pdf");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RelatorioComissaoRepres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RelatorioComissaoRepres().setVisible(true);
            }
        });
    }
