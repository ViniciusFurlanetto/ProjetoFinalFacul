 ...
 */
public class RepresCitySL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    TelaCidade TelaAtual;
    
    public RepresCitySL(TelaCidade obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RepresCitySL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void pPreenche () {
        ...
        try {
            model.addRow(new Object[]{0, "Nenhum"});
