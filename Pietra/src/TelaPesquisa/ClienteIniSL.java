 ...
 */
public class ClienteIniSL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    RelatorioClientes TelaAtual;
    
    public ClienteIniSL(RelatorioClientes obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteIniSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
