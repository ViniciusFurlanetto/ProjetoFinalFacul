 ...
 */
public class MunicipioSL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    TelaCidade TelaAtual;
    
    public MunicipioSL(TelaCidade obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MunicipioSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
