 ...
 */
public class ClienteSL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    TelaCliente TelaAtual;
    
    public ClienteSL(TelaCliente obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
