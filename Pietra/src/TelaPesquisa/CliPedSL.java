 ...
 */
public class CliPedSL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    TelaPedido TelaAtual;
    
    public CliPedSL(TelaPedido obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    private void BtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnConfirmarActionPerformed
        ...
        if (i != -1){
            ...
            obj = objDao.buscaClienteByID(Integer.parseInt(String.valueOf(jTable1.getValueAt(i, 0))));
            TelaAtual.pPreencheCliente(obj);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CliPedSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
