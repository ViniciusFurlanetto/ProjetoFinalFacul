 ...
 */
public class ClienteFimPSL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    RelatorioPedidos TelaAtual;
    
    public ClienteFimPSL(RelatorioPedidos obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteFimPSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
