 ...
 */
public class ClienteIniPSL extends javax.swing.JFrame {
    SqlServer Conecta = new SqlServer();
    ResultSet rs;
    RelatorioPedidos TelaAtual;
    
    public ClienteIniPSL(RelatorioPedidos obj) {
        initComponents();
        pPreenche(); 
        TelaAtual = obj;
    ...
    private void BtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnConfirmarActionPerformed
        ...
        if (i != -1){
            TelaAtual.pSetaClienteIni(Integer.parseInt(String.valueOf(jTable1.getValueAt(i, 0))));            
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteIniPSL.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
